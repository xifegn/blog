...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Collects = field.NewString(tableName, "collects")
	_user.Following = field.NewString(tableName, "following")
	_user.Fans = field.NewInt32(tableName, "fans")
...
type user struct {
	...
	Mobile     field.String // 用户电话
	Password   field.String // 用户密码
	Collects   field.String
	Following  field.String
	Fans       field.Int32
...
func (u *user) updateTableName(table string) *user {
	...
	u.Collects = field.NewString(table, "collects")
	u.Following = field.NewString(table, "following")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["collects"] = u.Collects
